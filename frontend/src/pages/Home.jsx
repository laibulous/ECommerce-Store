        ...
        <div className="container-custom py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mb-8 text-primary-100">
              Discover amazing products at unbeatable prices. Shop from thousands of items across all categories.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/products?featured=true" className="border-2 border-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-primary-600 transition inline-flex items-center gap-2">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { name: 'Books', icon: '📚', color: 'bg-green-100 hover:bg-green-200' },
              { name: 'Sports', icon: '⚽', color: 'bg-orange-100 hover:bg-orange-200' },
              { name: 'Home & Garden', icon: '🏡', color: 'bg-pink-100 hover:bg-pink-200' },
              { name: 'Beauty', icon: '💄', color: 'bg-red-100 hover:bg-red-200' },
              { name: 'Toys', icon: '🧸', color: 'bg-yellow-100 hover:bg-yellow-200' },
              { name: 'Other', icon: '🎁', color: 'bg-gray-100 hover:bg-gray-200' },
            ].map((category) => (
              <Link
                key={category.name}
